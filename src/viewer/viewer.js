        ...
        if (obj.isMesh) {
            for (const material of obj.material) {
                if (material.type === 'MeshPhongMaterial') {
                    shadingType = ShadingModelType.Phong;
                } else if (material.type === 'MeshStandardMaterial') {
                    shadingType = ShadingModelType.Physical;
                }
                return false;
            }
        }
...
export class ShadingModel
{
    constructor (scene)
    {
        ...
        this.type = ShadingModelType.Phong;
...
export class Viewer
{
    ...
    Init (canvas)
    {
        ...
        this.axis = new ViewerAxis (this.scene);

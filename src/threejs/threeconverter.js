...
import {GetRepresentativeMaterialType} from "../model/modelutils.js";
...
export function ConvertModelToThreeObject  (model, params, output, callbacks)
{
	function CreateThreeMaterial (stateHandler, model, materialIndex, materialType, params, output)
	{
		...
		} else if (materialType === MaterialType.Physical) {
	...
	let materialType = GetRepresentativeMaterialType (model);

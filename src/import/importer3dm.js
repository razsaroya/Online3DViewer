...
import {IsModelEmpty, TransformMesh} from "../model/modelutils.js";
import {Property, PropertyGroup, PropertyType} from "../model/property.js";
import {ConvertThreeGeometryToMesh} from "../threejs/threeutils.js";
import {Transformation} from "../geometry/transformation.js";
import {Material, MaterialIsEqual, MaterialType} from "../model/material.js";
	...
	GetMaterialIndex (rhinoDoc, rhinoObject, rhinoInstanceReferences)
	{
		...
		function FindMatchingMaterial (model, rhinoMaterial)
		{
			...
			for (let i = 0; i < model.MaterialCount (); i++) {
				...
				if (MaterialIsEqual (current, material)) {
					return i;
				}
			}

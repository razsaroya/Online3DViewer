...
import {LinearToSRGB, Material, MaterialType, TextureMap, Color} from "../model/material.js";
import {ImporterBase} from "./importerbase.js";
import {Direction} from "../geometry/geometry.js";
import * as Utils from "../io/bufferutils.js";
...
export class GltfExtensions
{
    ...
    ProcessMaterial (gltfMaterial, material, imporTextureFn)
    {
        ...
        {
            return parseInt (Math.round (LinearToSRGB (component) * 255.0), 10);
        }
...
export class ImporterGltf extends ImporterBase
{
    ...
    ImportMaterial (gltf, gltfMaterial)
    {
        ...
        let material = new Material (MaterialType.Physical);

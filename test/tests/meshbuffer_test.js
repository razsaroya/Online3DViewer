...
const {ConvertMeshToMeshBuffer} = require("../../source/model/meshbuffer");
...
describe ('Mesh Buffer', function () {
    it ('Mesh To Buffer Simple', function () {
        ...
        mesh.AddTriangle (new Triangle (0, 1, 2).SetNormals (0, 0, 0).SetMaterial (0));
        mesh.AddTriangle (new Triangle (0, 2, 3).SetNormals (0, 0, 0).SetMaterial (0));
        mesh.AddTriangle (new Triangle (4, 5, 6).SetNormals (0, 0, 0).SetMaterial (1));
        mesh.AddTriangle (new Triangle (4, 6, 7).SetNormals (0, 0, 0).SetMaterial (1));
    ...
    it ('Mesh To Buffer Different Normals', function () {
        ...
        mesh.AddNormal (new Coord3D (0.0, 0.0, -1.0));
        mesh.AddTriangle (new Triangle (0, 1, 2).SetNormals (0, 0, 0).SetMaterial (0));
        mesh.AddTriangle (new Triangle (0, 2, 3).SetNormals (1, 1, 1).SetMaterial (0));
    ...
    it ('Mesh To Buffer Different UVs', function () {
        ...
        mesh.AddVertex (new Coord3D (0.0, 1.0, 0.0));
        mesh.AddNormal (new Coord3D (0.0, 0.0, 1.0));
        mesh.AddTextureUV (new Coord3D (1.0, 1.0));
        mesh.AddTextureUV (new Coord3D (-1.0, -1.0));
        mesh.AddTriangle (new Triangle (0, 1, 2).SetNormals (0, 0, 0).SetTextureUVs (0, 0, 0).SetMaterial (0));
        mesh.AddTriangle (new Triangle (0, 2, 3).SetNormals (0, 0, 0).SetTextureUVs (1, 1, 1).SetMaterial (0));
    ...
    it ('Mesh To Buffer Same Normals and UVs', function () {
        ...
        mesh.AddTextureUV (new Coord3D (1.0, 1.0));
        mesh.AddTriangle (new Triangle (0, 1, 2).SetNormals (0, 0, 0).SetTextureUVs (0, 0, 0).SetMaterial (0));
        mesh.AddTriangle (new Triangle (0, 2, 3).SetNormals (0, 0, 0).SetTextureUVs (0, 0, 0).SetMaterial (0));
    ...
    it ('Mesh To Buffer Cube', function () {
        ...
        mesh.AddNormal (new Coord3D (0, -1, 0));
        mesh.AddNormal (new Coord3D (1, 0, 0));
        mesh.AddNormal (new Coord3D (0, 1, 0));
        mesh.AddNormal (new Coord3D (-1, 0, 0));
        mesh.AddNormal (new Coord3D (0, 0, -1));
        mesh.AddNormal (new Coord3D (0, 0, 1));

        mesh.AddTriangle (new Triangle (0, 1, 5).SetNormals (0, 0, 0));
        mesh.AddTriangle (new Triangle (0, 5, 4).SetNormals (0, 0, 0));
        mesh.AddTriangle (new Triangle (1, 2, 6).SetNormals (1, 1, 1));
        mesh.AddTriangle (new Triangle (1, 6, 5).SetNormals (1, 1, 1));
        mesh.AddTriangle (new Triangle (2, 3, 7).SetNormals (2, 2, 2));
        mesh.AddTriangle (new Triangle (2, 7, 6).SetNormals (2, 2, 2));
        mesh.AddTriangle (new Triangle (3, 0, 4).SetNormals (3, 3, 3));
        mesh.AddTriangle (new Triangle (3, 4, 7).SetNormals (3, 3, 3));
        mesh.AddTriangle (new Triangle (0, 3, 2).SetNormals (4, 4, 4));
        mesh.AddTriangle (new Triangle (0, 2, 1).SetNormals (4, 4, 4));
        mesh.AddTriangle (new Triangle (4, 5, 6).SetNormals (5, 5, 5));
        mesh.AddTriangle (new Triangle (4, 6, 7).SetNormals (5, 5, 5));

        model.AddMesh (mesh);
        FinalizeModel (model, function () {
    ...
    it ('Mesh To Buffer Cube Auto Curve Normals', function () {
        ...
        mesh.AddTriangle (new Triangle (0, 1, 5).SetCurve (1));
        mesh.AddTriangle (new Triangle (0, 5, 4).SetCurve (1));
        mesh.AddTriangle (new Triangle (1, 2, 6).SetCurve (1));
        mesh.AddTriangle (new Triangle (1, 6, 5).SetCurve (1));
        mesh.AddTriangle (new Triangle (2, 3, 7).SetCurve (1));
        mesh.AddTriangle (new Triangle (2, 7, 6).SetCurve (1));
        mesh.AddTriangle (new Triangle (3, 0, 4).SetCurve (1));
        mesh.AddTriangle (new Triangle (3, 4, 7).SetCurve (1));
        mesh.AddTriangle (new Triangle (0, 3, 2).SetCurve (1));
        mesh.AddTriangle (new Triangle (0, 2, 1).SetCurve (1));
        mesh.AddTriangle (new Triangle (4, 5, 6).SetCurve (1));
        mesh.AddTriangle (new Triangle (4, 6, 7).SetCurve (1));
    ...
    it ('Mesh To Buffer Cube Materials', function () {
        var model = new Model ();
        model.AddMaterial (new Material (MaterialType.Phong));
        model.AddMaterial (new Material (MaterialType.Phong));
        var mesh = new Mesh ();
        ...
        mesh.AddTriangle (new Triangle (0, 1, 5).SetMaterial (0));
        mesh.AddTriangle (new Triangle (0, 5, 4).SetMaterial (0));
        mesh.AddTriangle (new Triangle (1, 2, 6).SetMaterial (0));
        mesh.AddTriangle (new Triangle (1, 6, 5).SetMaterial (0));
        mesh.AddTriangle (new Triangle (2, 3, 7).SetMaterial (0));
        mesh.AddTriangle (new Triangle (2, 7, 6).SetMaterial (0));
        mesh.AddTriangle (new Triangle (3, 0, 4).SetMaterial (1));
        mesh.AddTriangle (new Triangle (3, 4, 7).SetMaterial (1));
        mesh.AddTriangle (new Triangle (0, 3, 2).SetMaterial (1));
        mesh.AddTriangle (new Triangle (0, 2, 1).SetMaterial (1));
        mesh.AddTriangle (new Triangle (4, 5, 6).SetMaterial (1));
        mesh.AddTriangle (new Triangle (4, 6, 7).SetMaterial (1));
    ...
    it ('Mesh To Buffer Cube One UV', function () {
        ...
        mesh.AddTriangle (new Triangle (0, 1, 5));
        mesh.AddTriangle (new Triangle (0, 5, 4));
        mesh.AddTriangle (new Triangle (1, 2, 6).SetTextureUVs (0, 1, 2));
        mesh.AddTriangle (new Triangle (1, 6, 5));
        mesh.AddTriangle (new Triangle (2, 3, 7));
        mesh.AddTriangle (new Triangle (2, 7, 6));
        mesh.AddTriangle (new Triangle (3, 0, 4));
    ...
    it ('Mesh To Buffer Cube All UVs', function () {
        ...
        mesh.AddTriangle (new Triangle (0, 1, 5).SetTextureUVs (0, 1, 2));
        mesh.AddTriangle (new Triangle (0, 5, 4).SetTextureUVs (0, 1, 2));
        mesh.AddTriangle (new Triangle (1, 2, 6).SetTextureUVs (0, 1, 2));
        mesh.AddTriangle (new Triangle (1, 6, 5).SetTextureUVs (0, 1, 2));
        mesh.AddTriangle (new Triangle (2, 3, 7).SetTextureUVs (0, 1, 2));
        mesh.AddTriangle (new Triangle (2, 7, 6).SetTextureUVs (0, 1, 2));
        mesh.AddTriangle (new Triangle (3, 0, 4).SetTextureUVs (0, 1, 2));
        mesh.AddTriangle (new Triangle (3, 4, 7).SetTextureUVs (0, 1, 2));
        mesh.AddTriangle (new Triangle (0, 3, 2).SetTextureUVs (0, 1, 2));
        mesh.AddTriangle (new Triangle (0, 2, 1).SetTextureUVs (0, 1, 2));
        mesh.AddTriangle (new Triangle (4, 5, 6).SetTextureUVs (0, 1, 2));
        mesh.AddTriangle (new Triangle (4, 6, 7).SetTextureUVs (0, 1, 2));
